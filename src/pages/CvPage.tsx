    ...
    <div className="principalCv">
        ...
        {visibleSection === "formation" && (
          <div className="cv-contener">
            {certData
              .sort((a, b) => b.id - a.id)
              .map((c) => (
                <div className="spandiv" key={c.id} onClick={() => toggleSection("formation")}>
                  <span>
        ...
        {visibleSection === "experiences" && (
          <div className="cv-contener">
            {expData
              .sort((a, b) => b.id - a.id)
              .map((e) => (
                <div className="spandiv" key={e.id}  onClick={() => toggleSection("experiences")}>
                  <span key={e.id}>
      ...
      <div className="infosCv">
        ...
        {visibleSection === "competences" && (
          <div className="cv-contener">
            {autreData.map((o) => (
              <div className="spandiv" key={o.id} onClick={() => toggleSection("competences")}>
                <span>
